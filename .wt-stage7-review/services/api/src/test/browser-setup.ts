...
const databaseName = "vulto_fdn60_browser";
const adminUrl =
  process.env.FDN60_ADMIN_DATABASE_URL ??
...
const certificateDirectory = "/tmp/vulto-fdn60-browser";
...
console.log("FDN-60 browser database migrated and local TLS material ready.");
