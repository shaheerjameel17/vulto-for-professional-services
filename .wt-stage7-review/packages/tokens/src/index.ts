...
/** The thirteen settled type tokens from VPS-D001's scale. */
export const TYPE_TOKENS = [
  ...
  "micro",
  "numeric",
  /* A medium-weight figure beside a lighter figure at the same size. */
  "numeric-medium",
  /* Supporting and leading figures in a summary group. */
  "numeric-md",
  "numeric-lg",
] as const;
