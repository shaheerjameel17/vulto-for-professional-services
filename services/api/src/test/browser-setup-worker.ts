...
const databaseName = "vulto_fdn77_browser";
const adminUrl =
  process.env.FDN77_ADMIN_DATABASE_URL ??
...
const certificateDirectory = "/tmp/vulto-fdn77-browser";
...
console.log(
  "FDN-77 worker-diagnostics browser database migrated and local TLS material ready.",
);
