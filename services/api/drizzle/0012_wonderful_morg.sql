CREATE TABLE "audit_journal" (
	...
	CONSTRAINT "audit_journal_event_type_check" CHECK ("audit_journal"."event_type" in ('PermissionDenied', 'SensitiveAccessGranted', 'AuthorizedOperationFailed', 'PrivilegedProjectionAuthorized')),
