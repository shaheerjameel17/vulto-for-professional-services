...
**Stage 25 (`VPS-F003`) is briefed (F307 to F317, all closed by ruling; Handoff section 26). Next action: wait for Codex's Stage 25 report and review it against the actual diff and the branch's CI runs read from the public API.**
