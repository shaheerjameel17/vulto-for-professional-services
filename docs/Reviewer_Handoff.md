...
| **9 The real shell bootstrap** | **blocked five times, all ruled (F216–F220, all 22 Sept); brief updated in place; `stage-9-shell-bootstrap-v3` is in progress with sound preliminary code, continuing past both the F219 and F220 fixes; three earlier branches abandoned with no bootstrap code** | — |
...
## 9. Stage 9 — the real shell bootstrap (briefed, F216 through F220)
