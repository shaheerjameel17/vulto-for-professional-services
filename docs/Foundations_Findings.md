...
**Open, pending founder review of the two source audit reports.** Not recorded as closed on my authority: the technical case is strong and the composability is clean, but I have not read the audits' own text directly.
