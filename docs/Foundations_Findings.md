...
**One hundred and thirty-two numbered rows: one hundred and thirteen closed, sixteen open, and three recorded facts or limitations.** F185 was added on 8 September 2026 as a recorded design boundary — `recoverPartition()`'s scope to an already-materialized partition — counted like F76 and F157 rather than as open or closed. F167 and F184 closed by founder ruling on 8 September 2026 — A003-T14's SLIP-0039 requirement is amended to the M-of-N property it was selected to provide, with `shamir-secret-sharing@0.0.3` (SRI-pinned) as the approved primitive; F167 is no longer a SLIP-0039-related blocker of any kind. F172–F175 and the two additional adversarial findings F180–F181 remain closed by direct repository proof. Existing unrelated open findings remain unchanged.
