...
**Status: open — Stage 11 blocked before code changes.** The owning specification needs to define the deactivation state change and reconcile the API signature with A003-T54's base-version rule. The Stage 11 brief then needs to reflect that ruling. No mutation, bootstrap, permission or UI code was changed for FDN-118.
